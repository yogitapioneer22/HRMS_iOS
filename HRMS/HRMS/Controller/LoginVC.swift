...
class LoginVC: UIViewController {
    ...
    @IBAction func btnEplyeeAction(_ sender: Any) {
        ...
        self.btnPasscode.tintColor = #colorLiteral(red: 0.5355603099, green: 0.7724923491, blue: 0.2494862974, alpha: 1)
    ...
    @IBAction func btnPasscodeAction(_ sender: Any) {
        ...
        self.btnEmpId.tintColor = #colorLiteral(red: 0.5355603099, green: 0.7724923491, blue: 0.2494862974, alpha: 1)
